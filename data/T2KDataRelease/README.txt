This folder contains the data release for the paper "Combined measurement of the muon neutrino charged-current cross section on Oxygen and Carbon without pion in the final state at T2K".
